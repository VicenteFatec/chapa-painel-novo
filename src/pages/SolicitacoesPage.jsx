...
function SolicitacoesPage() {
    ...
    // Função de busca com a correção final
    ...
    const handleAlocarChapa = async (chapa) => {
        ...
        try {
            ...
            batch.update(solicitacaoRef, { status: 'confirmado', chapaAlocadoId: chapa.id, chapaAlocadoNome: chapa.nomeCompleto });
    ...
    const handleFinalizarServico = async (solicitacao) => {
        ...
        try {
            ...
            batch.update(solicitacaoRef, { status: 'finalizado', dataFinalizacao: Timestamp.now() });
                ...
                <tr key={solicitacao.id}>
                    ...
                    <td>
                        <div className="datas-cell">
                            ...
                            {solicitacao.dataFinalizacao && ( <span><strong>Finalizado:</strong> {solicitacao.dataFinalizacao.toDate().toLocaleDateString('pt-BR')}</span> )}
                        </div>
                    </td>
                    <td>
    ...
    return (
        <div>
            ...
            <Modal isOpen={isDetalhesModalOpen} onClose={fecharDetalhesModal} title={`Encontrar Trabalhador para: ${solicitacaoSelecionada?.cliente}`}>
                <div className="curadoria-container">
                    <div className="curadoria-coluna">
                        ...
                        <div className="detalhes-solicitacao">
                            ...
                            <div className="detalhe-item"> <strong>Região do Serviço:</strong> <p>{solicitacaoSelecionada?.regiao}</p> </div>
                            <div className="detalhe-item"> <strong>Data da Solicitação:</strong> <p>{solicitacaoSelecionada?.dataSolicitacao.toDate().toLocaleString('pt-BR')}</p> </div>
                        </div>
                    </div>
